...
\begin{enumerate}
	...
	\item Number of images generated per user (or \emph{tool usage}) is not normally distributed. Q-Q plot and Kolmogorof-Smirnoff confirm exponential distribution (see \ref{fig:usagedesc}). Two outlier cases visible in the charts have been removed with a filter on number of generated images with condition $<= 400$.
\end{enumerate}
